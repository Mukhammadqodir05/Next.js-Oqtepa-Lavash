...
const MenuBar = () => {
  ...
  return (
    <main className='flex w-full h-full flex-col items-center justify-center'>
      {/* Bottombar */}
        <div className='flex w-full fixed border-t borderColor bg-black bottom-0 left-0 right-0 overflow-x-hidden items-center'>
          <div className='flex p-2 items-center absolute text-white left-0 bottom-0 pr-4 w-20 h-full bg-gradient-to-r from-black from-60% to-transparent'>
            <SlArrowLeft className='cursor-pointer' size={20} />
          </div>
          <div className="flex h-16 pl-14 w-full overflow-x-hidden">
            <div className="flex md:hidden justify-between items-center text-white h-full">
              ...
              <div className='flex ml-[50px] w-full'></div>
            </div>
            </div>
            <div className='flex items-center absolute text-white right-0 p-2 bottom-0 bg-gradient-to-l justify-end from-black from-60% to-transparent w-20 h-full'>
              <SlArrowRight className='cursor-pointer' size={20} />
            </div>
         </div>
